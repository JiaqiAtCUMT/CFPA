...
def parse_args(in_args=None):
    ...
    parser.add_argument("--config-file",
                        default="/private/few-shot-object-detection-master/configs/PascalVOC-detection/split1/faster_rcnn_R_101_FPN_base1.yaml",
                        metavar="FILE", help="path to config file")
    parser.add_argument("--output-dir", default="/private/dir", help="path to output directory")
    ...
    if args.source == "dataloader":
        ...
        for batch in train_data_loader:
            for per_image in batch:
                # type(per_image), per_images.keys()
                # <class 'dict'>, dict_keys(['file_name', 'image_id', 'height', 'width', 'image', 'instances'])
