...
VOC_CLASSES = ["plane", "ship", "storage-tank", "large-vehicle", "small-vehicle", "soccer-ball-field", "bridge", "helicopter",
    "baseball-diamond", "tennis-court", "swimming-pool", "ground-track-field", "harbor", "roundabout", 
    "basketball-court"]
...
def generate_seeds(args):
    ...
    for year in [2007, 2012]:
        data_file = 'datasets/VOC2020/ImageSets/Main/trainval.txt'.format(year)
